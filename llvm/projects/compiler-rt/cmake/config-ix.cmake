...
set(ALL_TESTSAN_SUPPORTED_ARCH ${X86_64} ${X86}) 
...
if(APPLE)
 ...
 list_intersect(TESTSAN_SUPPORTED_ARCH
  ...
  message([STATUS] "after intersect " ${TESTSAN_SUPPORTED_ARCH})
...
#Add your sanitizer to the list of all sanitizers
set(ALL_SANITIZERS asan;dfsan;msan;hwasan;tsan;safestack;cfi;esan;scudo;ubsan_minimal;testsan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND TESTSAN_SUPPORTED_ARCH AND 
		OS_NAME MATCHES "Linux")
	message([STATUS] "SETTING TESTSAN TRUE")
